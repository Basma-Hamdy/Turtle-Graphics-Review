...
public class RulesOf6005 {
	/**
	 * Judge whether a given piece of code may be used in an assignment (problem set
	 * or team project) or not, according to the 6.005 collaboration policy. 
	 ...
	 * @param implementationRequired whether the assignment specifically asks you to
	 *                               implement the feature in question.
	 * @return Whether or not, based on the information provided in the arguments,
	 *         you are likely to be allowed to use the code in question in your
	...
	/**
	 * Main method of the class. Runs the mayUseCodeInAssignment method.
	 * @param args unused
	 */
